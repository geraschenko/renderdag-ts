// Port of eden/scm/lib/renderdag/src/ascii.rs.

import { PrefixLinesToText } from './pipeline/prefix_lines_to_text.js';
import { AsciiPrefixLineRenderer } from './pipeline/row_shape_to_prefix_lines/ascii.js';
...
export class AsciiRenderer<N> implements Renderer<N, string> {
  private inner: Renderer<N, GraphRow<N>>;
  private prefixLines = new AsciiPrefixLineRenderer();
